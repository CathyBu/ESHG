    ...
    for preName in preNameList:
      ...
      # for sup in [ 0.003,0.005,0.008]:  #张
       ...
       # 手动修改名称 end
        ...
        filename = '../ECMA_AP1/ECMA_%s_Apriori_16_0.001_128_0.0002-XR2.csv' % (preName)  #
        ...
        writecsvname = 'tj_result_60_0.001_128_0.0002-ls/%s_0618-2.csv' % preName  #
        ...
        items  = tj(inFile)
        wn = 'bc_60_0.001_128_0.0002-ls/tj_%s_apriori-2.csv' % preName
      ...
      all_r.append(['','','',''])
    import csv
    with open('top_result-0.001-128-0.0002-ls-2.csv','wb') as fw:
        writer = csv.writer(fw)
